...
namespace VirtoCommerce.GoogleEcommerceAnalyticsModule.Client.Client
{
    /// <summary>
    ...
    public class Configuration
    {
        ...
        {
            string report = "C# SDK (VirtoCommerce.GoogleEcommerceAnalyticsModule.Client) Debug Report:\n";
